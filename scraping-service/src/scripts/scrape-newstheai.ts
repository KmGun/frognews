...
async function main() {
  try {
    ...
    console.log('🚀 NewsTheAI 스크래핑 시작...');
    scrapingLogger.info('NewsTheAI 스크래핑 시작...');
    
    const result = await scrapeNewsTheAiNews(openaiApiKey);
...
export { main as scrapeNewsTheAiMain }; 